...
signupValidation = () =>{
  ...
  return (req, res, next) => {
    ...
    // if(!req.body.issubscriptionactive){
    //   res.status(400)
    //   res.json({error: "invalid details", error_description: "subscription feild is required"})
    //   return
    // }
    // if(!req.body.purchaseditems){
    //   res.status(400)
    //   res.json({error: "invalid details", error_description: "items purchased is required"})
    //   return
    // }
    next()
  }
